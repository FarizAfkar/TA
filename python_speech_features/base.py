...
def mfcc(signal, samplerate=16000, winlen=0.025, winstep=0.01, numcep=13,
    ...
    :param nfft: the FFT size. Default is None, which uses the calculate_nfft function to choose the smallest size that
                does not drop sample data.
...
def delta(feat, N):
    ...
    :returns: A numpy array of size (NUMFRAMES by number of features) containing delta features.
